...
Communicates with Node B ([RadioBleBridge](/devices/radio-ble-bridge)) and other nodes in the same network.

See the [radio guide](/guide/radio) for the full API walkthrough.
...
See the [firmware guide](/guide/firmware) and the
[firmware README](https://github.com/femus/femus/blob/main/firmware/README.md)
for library setup and IDE instructions.
...
| **Firmware upload fails** | Ensure FemusFirmata libraries are installed: ConfigurableFirmata, HX711, RadioHead. See the [firmware README](https://github.com/femus/femus/blob/main/firmware/README.md) |
...
([`examples/lcd-clock-parallel.php`](https://github.com/femus/femus/blob/main/examples/lcd-clock-parallel.php)). To use radio:
...
Node B (see the [RadioBleBridge page](/devices/radio-ble-bridge)) listens on address 2 by default and bridges
...
2. Wire BLE + radio modules to Node B (see the [RadioBleBridge page](/devices/radio-ble-bridge))
...
- **[Radio guide](/guide/radio)** — API and messenger walkthrough
- **[Firmware guide](/guide/firmware)** and the [firmware README](https://github.com/femus/femus/blob/main/firmware/README.md) — radio sysex protocol and wiring details
- **[RadioBleBridge](/devices/radio-ble-bridge)** — Node B (BLE + radio bridge)
